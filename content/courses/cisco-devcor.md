...
## 学習内容
#### モジュール01: 保守性を考慮した設計 (*自習)

#### モジュール02: サービス性の設計 (*自習)

#### モジュール03: ChatOpsアプリケーションの実装

#### モジュール04: 高度なREST API統合

#### モジュール05: アプリケーションデータの保護 (*自習)

#### モジュール06: Webおよびモバイルアプリケーションの保護 (*自習)

#### モジュール07: アプリケーションリリースの自動化

#### モジュール08: アプリケーションの配備

#### モジュール09: 分散システムについて

#### モジュール10: ネットワークとインフラストラクチャのオーケストレーション

#### モジュール11: YANGデータモデリング

#### モジュール12: リレーショナルデータベースと非リレーショナルデータベースの使用 (*自習)
