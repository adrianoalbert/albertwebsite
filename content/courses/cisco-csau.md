...
#### モジュール03: Pythonを使ったネットワーク自動化

#### モジュール04: NetDevOps：ネットワーキングのDevOps

#### モジュール05: 自動化開発環境の管理

#### モジュール06: HTTPネットワークAPIの概要

#### モジュール07: データ形式とデータエンコーディング

#### モジュール08: Python Requestsを使用したHTTPベースAPI

#### モジュール09: YANG

#### モジュール10: YANGツールの使用

#### モジュール11: Pythonによるモデル駆動型APIの自動化

#### モジュール12: Ansibleを使ったネットワーク自動化

#### モジュール13: Jinja2を使用した設定のテンプレート化
